...
DEEPSEEK_API_KEY = os.environ.get("DEEPSEEK_API_KEY", "sk-0a57f72b50854ace9d134a5eb697c4dc")
DEEPSEEK_API_URL = "https://api.deepseek.com/v1/chat/completions"

# 输入目录（step1 输出）
CLUSTERING_RESULT_DIR = "gnn_leiden_results"
# 社区报告目录（step2 输出）
COMMUNITY_REPORTS_DIR = "community_reports"
# 输出目录
OUTPUT_DIR = "build_hierarchy_links_output"
