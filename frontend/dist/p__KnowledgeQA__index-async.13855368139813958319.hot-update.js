globalThis.makoModuleHotUpdate('p__KnowledgeQA__index', {
    modules: {
        "src/pages/KnowledgeQA/index.tsx": function(module, exports, __mako_require__) {
            ...
            const KnowledgeQA = ()=>{
                ...
                const { messages, currentSubgraph, alignmentFeatures, isLoading, sendMessage, clearHistory, pendingRecommendations, clarifyMessage, activeRightPanel, riskReport, riskStages, riskCommunity, error } = (0, _agentStore.useAgentStore)();
                ...
                (0, _react.useEffect)(()=>{
                    ...
                    const timer = setTimeout(()=>{
                        ...
                        if (messages.length > 0 || currentSubgraph || analysisResult || riskReport) {
                            var _analysisResult, _analysisResult1, _analysisResult2;
                            ...
                            updateCurrentSession({
                                ...
                                workspaceState: {
                                    ...
                                    chartOptions: (_analysisResult = analysisResult) === null || _analysisResult === void 0 ? void 0 : _analysisResult.echarts_config,
                                    stats: {
                                        rawData: (_analysisResult1 = analysisResult) === null || _analysisResult1 === void 0 ? void 0 : _analysisResult1.raw_data,
                                        rowCount: (_analysisResult2 = analysisResult) === null || _analysisResult2 === void 0 ? void 0 : _analysisResult2.row_count
                                    },
                                    riskReport,
                                    riskStages,
                                    riskCommunity
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)("div", {
                                                            ...
                                                            children: activeRightPanel === 'risk' ? /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_RiskReportPanel.default, {
                                                                ...
                                                                lineNumber: 556,
                                                                columnNumber: 19
                                                            }, this) : activeRightPanel === 'analysis' ? /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(AnalysisPanel, {
      ...
      `
            ...
            _s(KnowledgeQA, "3MskC5z3mwiOlwubtJMOVo+Oge8=", false, function() {
                return [
                    _antd.App.useApp,
    ...
    runtime._h = '17362545292046743723';
...
//# sourceMappingURL=p__KnowledgeQA__index-async.13855368139813958319.hot-update.js.map