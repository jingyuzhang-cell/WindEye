globalThis.makoModuleHotUpdate('p__KnowledgeQA__index', {
    modules: {
        "src/pages/KnowledgeQA/components/WorkspaceContainer.tsx": function(module, exports, __mako_require__) {
            ...
            const WorkspaceContainer = ({ messages, isLoading, pendingRecommendations, onSendMessage, onClearHistory, onEntityHover, onEntityClick, highlightedEntity, graphInjectedEntity, onClearGraphInject })=>{
                ...
                (0, _agentStore.useAgentStore)((s)=>s.uploadedFile);
                (0, _agentStore.useAgentStore)((s)=>s.fileUploading);
                (0, _agentStore.useAgentStore)((s)=>s.uploadFile);
                (0, _agentStore.useAgentStore)((s)=>s.clearUploadedFile);
                (0, _agentStore.useAgentStore)((s)=>s.error);
                (0, _react.useEffect)(()=>{
    ...
    runtime._h = '3740751153255243726';
...
//# sourceMappingURL=p__KnowledgeQA__index-async.695588383691818524.hot-update.js.map